...
#         self.outputs = outputs
#
#         self.conv1 = BBBConv1d(inputs, 32, 3, alpha_shape=(1, 1), padding=2, bias=False, name='conv1')
#         self.soft1 = nn.Softplus()
#         self.pool1 = nn.MaxPool1d(kernel_size=3, stride=1)
#
#         self.conv2 = BBBConv1d(32, 32, 3, alpha_shape=(1, 1), padding=2, bias=False, name='conv2')
#         self.soft2 = nn.Softplus()
#         self.pool2 = nn.MaxPool1d(kernel_size=3, stride=1)
#
#         self.flatten = FlattenLayer(8 * 32)
#         self.fc1 = BBBLinear(8 * 32, 100, alpha_shape=(1,1), bias=False, name='fc1')
#         self.soft5 = nn.Softplus()
#
